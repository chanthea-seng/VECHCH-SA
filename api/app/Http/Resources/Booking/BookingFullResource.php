...
class BookingFullResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'birth' => Carbon::parse($this->dob)->format('d/m/Y'),
            'gender' => $this->gender,
            ...
            'file' => $this->file ? route('file.download', ['filename' => $this->file]) : null,
            'paymentImage' => $this->paymentImage ? route('file.download', ['filename' => $this->paymentImage]) : null,
